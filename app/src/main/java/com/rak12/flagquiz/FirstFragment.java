...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        quizLinearLayout =
                (LinearLayout) view.findViewById(R.id.qll);
        questionNumberTextView =
                (TextView) view.findViewById(R.id.qno);
        flagImageView = (ImageView) view.findViewById(R.id.flagimageView);
        guessLinearLayouts = new LinearLayout[4];
        guessLinearLayouts[0] =
                (LinearLayout) view.findViewById(R.id.r1);
        guessLinearLayouts[1] =
                (LinearLayout) view.findViewById(R.id.r2);
        guessLinearLayouts[2] =
                (LinearLayout) view.findViewById(R.id.r3);
        guessLinearLayouts[3] =
                (LinearLayout) view.findViewById(R.id.r4);
        answerTextView = (TextView) view.findViewById(R.id.ans);
    ...
    public void updateGuessRows(SharedPreferences sharedPreferences) {
        ...
        String choices =
                sharedPreferences.getString(MainActivity.c, null);
    ...
    public void updateRegions(SharedPreferences sharedPreferences) {
        regionsSet =
                sharedPreferences.getStringSet(MainActivity.r, null);
    }
        ...
        public void onClick(View v) {
            ...
            if (guess.equals(answer)) { // if the guess is correct
                ...
                answerTextView.setTextColor(getResources().getColor(
                        R.color.incorrect, getContext().getTheme()));
